...
open class APJTextPickerView: ACFloatingTextfield {
...
//        let button = self.value(forKey: "_clearButton") as! UIButton
...
//    }
    ...
    private func _updateCurrentIndexSelected() {
        ...
        if let row = currentIndexSelected, count > 0, row < count {
